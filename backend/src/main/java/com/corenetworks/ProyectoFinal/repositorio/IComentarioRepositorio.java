...
public interface IComentarioRepositorio extends IGeneralRepositorio <Comentario, Integer> {
    @Query("SELECT NEW com.corenetworks.ProyectoFinal.dto.ComentarioDTO(" +
            "c.idComentario, c.likes,c.mensajes,c.publicacion.idPublicacion,c.publicacion.usuario.nombreUsuario,c.usuario.nombreUsuario , c.usuario.idUsuario,c.fCreacion, c.hCreacion) " +
            "FROM Comentario c " +
